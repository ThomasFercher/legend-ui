...
/// Marks a widget as themable — `nomo_gen themes` generates its theme
...
/// Marks a field of a [NomoThemeable] widget as a themed property.
@Target({TargetKind.field})
class Themed {
  const Themed({required this.defaultsTo, this.lerp = false});

  /// A Dart expression over `t` (a `NomoTokens` instance), evaluated in the
  /// generated `defaults(NomoTokens t)` factory — e.g. `'t.colors.primary'`
