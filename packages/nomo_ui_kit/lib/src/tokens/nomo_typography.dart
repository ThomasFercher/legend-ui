...
/// tokens (`NomoColors`) at the component level.
class NomoTypography {
  const NomoTypography({
  ...
  static NomoTypography lerp(NomoTypography a, NomoTypography b, double t) {
    return NomoTypography(
