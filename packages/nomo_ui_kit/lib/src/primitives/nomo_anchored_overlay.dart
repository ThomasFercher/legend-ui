...
class NomoAnchoredOverlay extends StatefulWidget {
  const NomoAnchoredOverlay({
  ...
  @override
  State<NomoAnchoredOverlay> createState() => _NomoAnchoredOverlayState();
}

class _NomoAnchoredOverlayState extends State<NomoAnchoredOverlay> {
