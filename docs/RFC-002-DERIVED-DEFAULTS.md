...
| **D — playground & docs CMS** | manifest-driven configurator over every variable; Theme reference page; `LegendThemeController` in kit | in progress (2026-07-10): `LegendThemeController` moves into the kit; the configurator is generated from the `*.docs.g.dart` manifests (coverage target: 100% of entries); Theme reference page + seed section in the docs site |
