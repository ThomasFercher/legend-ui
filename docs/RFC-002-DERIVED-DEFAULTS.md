...
| **F — remaining ports & primitives** | [RFC-003](RFC-003-LEGEND-BODY.md) `LegendBody` + `LegendSliver*` helpers + docs-site migration; `LegendFieldCore` extraction; `LegendInteractive` vocabulary (secondary-tap, focus-tap); vertical menu port | queued (2026-07-10) behind E |
